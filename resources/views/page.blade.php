...
<body class="home" data-gr-c-s-loaded="true" cz-shortcut-listen="true">
        ...
        <div id="global-site-content">
            <div class="mainContainer">
                ...
                <div class="global-nav">
                    ...
                    <a href="/" class="global-nav-logo" title="The Bill &amp; Melinda Gates Foundation"><span>Chortoq Foundation</span></a>
                    ...
                    <select class="global-nav-locale" name="global-nav-locale" id="global_nav_locale">
                        <option class="global-nav-locale" selected="" disabled="">Lang</option>


                        <option class="global-nav-locale" value="/en/" title="en"
                            style="background-color: rgb(253, 253, 253); color: rgb(136, 136, 136);">Eng</option>
            ...
            <div class="container">
                            <div class="row">
                                <div class="col-sm-12 col-lg-12 col-md-12 mt-3 about-us-copy">
                                    <h1 align="center">@lang('home.'.str_replace('-',' ',strtoupper(Request::path())))</h1>
                                    <h5 align="center" class="sans-serif about-us-title push-bottom">
                                        {{ $data['content'][Request::path()][0] }}
                                    </h5>
                                    <p class="serif about-us-description">   {!! $data['content'][Request::path()][1] !!}</p>
                                </div>
    ...
    <div id="_atssh" style="visibility: hidden; height: 1px; width: 1px; position: absolute; top: -9999px; z-index: 100000;"><iframe id="_atssh52" title="AddThis utility frame" src="/js/sh.f48a1a04fe8dbf021b4cda1d.html" style="height: 1px; width: 1px; position: absolute; top: 0px; z-index: 100000; border: 0px; left: 0px;" data-gtm-yt-inspected-8775721_12="true" data-gtm-yt-inspected-8775721_248="true"
            data-gtm-yt-inspected-8775721_261="true" data-gtm-yt-inspected-8775721_213="true" data-gtm-yt-inspected-8775721_355="true"></iframe></div>
    <style id="service-icons-0"></style>



    <script type="text/javascript" id="" src="/js/iframe_api">
        < /div >
    </script>
