...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" media="screen,print" href="/css/style_AE291F9A3B79882AFB0DE20994220A22.min.css">
    <link rel="stylesheet" type="text/css" media="screen" href="/css/responsive_66E0D21F457D6A9A3818C040C407D25B.min.css">
    <link rel="stylesheet" type="text/css" media="screen,print" href="/css/search_D3D846FA5233880706E5018894B49F07.min.css">
    <link rel="stylesheet" type="text/css" media="print" href="/css/print_B766AEC5C6F77AF4024B3FE6CED8543F.min.css">
    <link rel="stylesheet" type="text/css" media="screen" href="/css/jquery.loadmask_4EADE2AC96C5D7F472375E93C2B6A0B1.min.css">
    <link rel="stylesheet" href="/css/main-generated.css">
    <link rel="apple-touch-icon" sizes="180x180" href="/img/fav/apple-touch-icon.png">
    <link rel="icon" type="/img/fav/png" sizes="32x32" href="/img/fav/favicon-32x32.png">
    <link rel="icon" type="/img/favpng" sizes="16x16" href="/img/fav/favicon-16x16.png">
    ...
    <script src="/js/fdu6nid.js"></script>
    <style type="text/css">
        .tk-ff-din-web {
    ...
    <style type="text/css">
        @font-face {
            ...
            src: url('/fonts/DINPro-Regular.woff2') format("woff2"), url('/fonts/DINPro-Regular.woff2') format("woff"), url('/fonts/DINPro-Regular.woff2') format("opentype");
            font-weight: 700;
            font-style: normal;
        }
        ...
        @font-face {
            font-family: ff-din-web;
            src: url('/fonts/DINPro-Regular.woff') format("woff2"), url('/fonts/DINPro-Regular.woff') format("woff"), url('/fonts/DINPro-Regular.woff') format("opentype");
            font-weight: 400;
            font-style: normal;
        }
        ...
        @font-face {
            font-family: ff-din-web;
            src: url('/fonts/DINPro-Regular.woff2') format("woff2"), url('/fonts/DINPro-Regular.woff') format("woff"), url('/fonts/DINPro-Regular.woff') format("opentype");
            font-weight: 600;
            font-style: normal;
        }
        ...
        @font-face {
            font-family: minion-pro;
            src: url('/fonts/MinionPro-Regular.woff2') format("woff2"), url('/fonts/MinionPro-Regular.woff') format("woff"), url('/fonts/MinionPro-Regular.woff') format("opentype");
            font-weight: 700;
            font-style: italic;
        }
    ...
    <script src="/js/modernizr2.6.1.min.js"></script>

    <script src="/js/jquery-1.7.2.min.js"></script>

    <!--[if IE]>
			<script src="/javascripts/gfo/libs/json2_C984103F6611A342C809C2173952B8B8.min.js"></script>
		<![endif]-->


    <script src="/js/combined_AFA0ABD6A4239C79DFB7DEF6993B9F34.js"></script>
    <script src="/js/combined_7D984CD4FDF7FC98C99DAD90A661D34C.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="/css/main.css?rand={{rand() }}">
    <link rel="stylesheet" type="text/css" href="/css/wffm_form.css">
    <script>
        jQuery(document).ready(function() {
            var twoLetter = 'en';
            var langStr = twoLetter != 'zh' ? twoLetter : 'zh-cn';
            moment.lang(langStr);

            $('.read-more').readMore({
                button_text_open: 'Read More',
                button_text_close: 'Read Less'
            });
        });
    ...
    <link rel="stylesheet" type="text/css" media="screen,print" data-skrollr-stylesheet="" href="/css/bgh-generated_49496BB12C6C5B441780C21E195F1A3A.min.css">
    <title>
        Chortoq Foundation - We are committed to support underprivileged students in Uzbekistan and open new frontiers of opportunities for them by providing professional courses in the hospitality sector.
    </title>
    ...
    <script type="text/javascript" charset="utf-8" async="" src="/js/layers.ab5cd98fe1b9a38a4a9f.js"></script>
    <style type="text/css">
        .at-share-dock.atss {
            top: auto;
            left: 0;
